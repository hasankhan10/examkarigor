...
export const questionBank: Question[] = [
  ...
  },
  {
    ...
    chapter: 'একচলবিশিষ্ট দ্বিঘাত সমীকরণ',
    type: 'SAQ',
    text: 'একটি দ্বিঘাত সমীকরণের বীজদ্বয়ের সমষ্টি 14 এবং গুণফল 24 হলে, দ্বিঘাত সমীকরণটি লিখুন।',
    marks: 2,
  },
  {
    id: 3,
    ...
    chapter: 'একচলবিশিষ্ট দ্বিঘাত সমীকরণ',
    type: 'Long',
    text: 'দুই অঙ্কের একটি ধনাত্মক সংখ্যাকে উহার এককের ঘরের অঙ্ক দিয়ে গুণ করলে গুণফল 189 হয় এবং দশকের ঘরের অঙ্ক এককের ঘরের অঙ্কের দ্বিগুণ। এককের ঘরের অঙ্কটি নির্ণয় করুন।',
    marks: 5,
  },
  // Class 10 Science
  {
  ...
  },
  {
    ...
    chapter: 'আলো',
    type: 'SAQ',
    text: 'আলোর বিচ্ছুরণের একটি প্রাকৃতিক উদাহরণ দিন।',
    marks: 2,
  },
  // Class 9 Math
  {
    ...
    type: 'SAQ',
    text: 'দুটি অমূলদ সংখ্যার উদাহরণ দাও যাদের গুণফল একটি মূলদ সংখ্যা।',
    marks: 2,
  },
  {
    id: 7,
    ...
    type: 'Long',
    text: 'যদি a + b + c = 0 হয়, তবে দেখাও যে, 1/(xᵇ+x⁻ᶜ+1) + 1/(xᶜ+x⁻ᵃ+1) + 1/(xᵃ+x⁻ᵇ+1) = 1',
    marks: 5,
  },
];
