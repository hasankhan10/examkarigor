...
export default function QuestionBank({ questions, isLoading, onAddQuestion, selectedIds }: QuestionBankProps) {
        ...
        <ScrollArea className="h-96 w-full">
            {isLoading ? (
                <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground py-16">
                    ...
                    <p className="font-headline text-lg">{t('ai_question_bank_loading')}</p>
                    <p className="text-sm">{t('ai_spinner_desc')}</p>
                </div>
            ) : (
